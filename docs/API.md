...
```json
{
  "next_node_id": "bst_deletion",
  "rationale": "You've mastered insertion (75% mastery). Deletion builds on this and is next in the schedule.",
  "current_progress": {
    "nodes_completed": 3,
    "total_nodes": 12,
...
**Response** (200 OK - no next node):
```json
{
  "next_node_id": null,
  "rationale": "Congratulations! You've completed all nodes in this plan.",
  "current_progress": {
    "nodes_completed": 12,
    "total_nodes": 12,
